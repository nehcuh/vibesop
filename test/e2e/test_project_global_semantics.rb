...
class TestProjectGlobalSemantics < Minitest::Test
  ...
  def test_claude_code_global_has_all_docs
    ...
    assert File.exist?(File.join(vibe_dir, 'behavior-policies.md')), "Global should have behavior-policies.md"
    assert File.exist?(File.join(vibe_dir, 'safety.md')), "Global should have safety.md"
    assert File.exist?(File.join(vibe_dir, 'task-routing.md')), "Global should have task-routing.md"
    assert File.exist?(File.join(vibe_dir, 'test-standards.md')), "Global should have test-standards.md"
  end
