    ...
    @base_manifest = {
      ...
      'security' => {
        'severity_levels' => {
          ...
          'P1' => { 'label' => 'high_risk_review',
                    'runtime_action' => 'require_context_review' },
          'P2' => { 'label' => 'warning', 'runtime_action' => 'warn_log_continue' }
        },
        'signal_categories' => [
          { 'id' => 'network_egress', 'base_severity' => 'P1',
            'indicators' => ['http_url'] },
          { 'id' => 'destructive_operation', 'base_severity' => 'P0',
            'indicators' => ['rm -rf'] }
        ],
        'adjudication_factors' => %w[asset_sensitivity execution_capability
                                     scope_of_change],
        'target_actions' => {
