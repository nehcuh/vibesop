...
Generated from the portable `core/` spec with profile `antigravity-default`.## Optional Integrations
...
# For Antigravity, manually register the skills in your tool's skill system
...
**Note**: RTK works best with Claude Code. For Antigravity, you may need to manually prefix commands with `rtk`.
...
- `P0` — Surface as a blocking project rule or execution deny logic.
- `P1` — Ask through manual notification tool or review approval.
